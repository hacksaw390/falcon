					...
					<div class="container">
						<div class="row">
							<div class="col-lg-12 m-auto bg-secondary py-1">
								...
								<?php }  ?>
								<form action="testi_post.php" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										<input value="" type="text" class="form-control " name="testi_name" placeholder="Testimonial Name">
									</div>
									...
									<div class="form-group">
										<textarea name="testi_desp" id="" cols="3" class="form-control" placeholder="Write Testimonial Description"></textarea>
									</div>
									<div class="from-group pb-3" >
										...
										<input type="file" name="testi_img" class="form-control">
									</div>
									<div class="form-group">
