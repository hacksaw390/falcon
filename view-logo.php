...
<?php
require 'db.php';
	$select = "SELECT * FROM logos WHERE logo_del_status = 0 ORDER BY id DESC";
									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												<?php } else{ ?>
													<a href="" class="btn btn-danger" data-toggle="modal" data-target="#logo_modal<?php echo $value['id']  ?>">Deactive</a>
													...
													<div class="modal-dialog" role="document">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<a class="btn btn-danger text-white" href="active-logo.php?id=<?php echo $value['id'] ?>">Yes</a>
															</div>
														</div>
													</div>
												</div>
