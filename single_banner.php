			...
			<div class="row">
				<div class="col-lg-12 m-auto">
					<div class="card bg-light mb-2">
						<div class="card-header text-white" style="background: linear-gradient(88deg, #13b4ca, #18cabe);" ><h3> Banner Info</h3></div>
						<div class="card-body">
							<table class="table table-bordered">
								...
								<tr>
									<th>BANNER TITLE</th>
									<td><?php echo $catch_user['banner_title'] ?></td>
								</tr>
								<tr>
									<th>BENNER DESCRIPTION</th>
									<td><?php echo $catch_user['banner_desp'] ?></td>
								</tr>
								<tr>
									<th>BUTTON</th>
									<td><?php echo $catch_user['banner_btn'] ?></td>
								</tr>
								<tr>
									<th>PHOTO</th>
									<td><img src="uploads/banners/<?php echo $catch_user['banner_img'] ?>" alt="" width='300'></td>
								</tr>
							</table>
							<a href="view-banner.php" class="btn btn-primary">Back</a>
						</div>
					</div>
				</div>
			</div>
